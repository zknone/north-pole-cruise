...
/* harmony import */ var _modules_switch_class__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/switch-class */ "./js/modules/switch-class.js");
/* harmony import */ var _vendor_leaflet__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./vendor/leaflet */ "./js/vendor/leaflet.js");
/* harmony import */ var _vendor_leaflet__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_vendor_leaflet__WEBPACK_IMPORTED_MODULE_4__);
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  window.addEventListener('load', function () {
    ...
    menuButton.addEventListener('click', _modules_switch_class__WEBPACK_IMPORTED_MODULE_3__["onClickMenu"]);
    var map = _vendor_leaflet__WEBPACK_IMPORTED_MODULE_4__["L"].map('map').setView([59.9387165, 30.3230474], 13);
    _vendor_leaflet__WEBPACK_IMPORTED_MODULE_4__["L"].tileLayer('http://{s}.google.com/vt?lyrs=m&x={x}&y={y}&z={z}', {
      maxZoom: 20,
      subdomains: ['mt0', 'mt1', 'mt2', 'mt3'],
      attribution: '&copy; <a href="http://www.openstreetmap.org/copyright">OpenStreetMap</a>'
    }).addTo(map);
    var icon = _vendor_leaflet__WEBPACK_IMPORTED_MODULE_4__["L"].icon({
      iconUrl: './img/map-pin.svg',
      iconSize: [38, 50]
    });
    _vendor_leaflet__WEBPACK_IMPORTED_MODULE_4__["L"].marker([59.9387165, 30.3230474], {
      icon: icon
    }).addTo(map).openPopup();
  });
});
