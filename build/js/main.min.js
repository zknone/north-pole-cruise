...
/* harmony import */ var _modules_form_validate_form__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./modules/form-validate/form */ "./js/modules/form-validate/form.js");
/* harmony import */ var _modules_switch_class__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/switch-class */ "./js/modules/switch-class.js");
/* harmony import */ var _modules_bear_overflow__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/bear-overflow */ "./js/modules/bear-overflow.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  window.addEventListener('load', function () {
    var form = new _modules_form_validate_form__WEBPACK_IMPORTED_MODULE_0__["Form"]();
    window.form = form;
    form.init();
    var menuButton = document.querySelector('[data-button]');
    menuButton.addEventListener('click', _modules_switch_class__WEBPACK_IMPORTED_MODULE_1__["onClickMenu"]);
    var navigationList = document.querySelector('[data-navigation-list]');
    _modules_bear_overflow__WEBPACK_IMPORTED_MODULE_2__["resizeObject"].observe(navigationList);
    var L = window.L;
    var map = L.map('map').setView([59.9387165, 30.3230474], 13);
    ...
    L.marker([59.9387165, 30.3230474], {
      icon: icon
    }).addTo(map).openPopup();
  });
});
...
/***/ "./js/modules/bear-overflow.js":
/*!*************************************!*\
  !*** ./js/modules/bear-overflow.js ***!
  \*************************************/
/*! exports provided: resizeObject */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "resizeObject", function() { return resizeObject; });
var resizeObject = new ResizeObserver(function (elements) {
  function bearOverflow() {
    if (height >= 180) {
      var heroSection = document.querySelector('[data-hero-section]');
      var additionalPadding = 120 + height;
      heroSection.style.paddingTop = "".concat(additionalPadding, "px");
    }
  }
  var rect = elements[0].contentRect;
...
/***/ "./js/modules/switch-class.js":
/*!************************************!*\
  !*** ./js/modules/switch-class.js ***!
  \************************************/
/*! exports provided: onClickMenu */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "onClickMenu", function() { return onClickMenu; });
function switchClass(el, activator) {
  var elements = document.querySelectorAll(el);
  elements.forEach(function (element) {
    return element.classList.toggle(activator);
  });
}
function removeClass(el, activator) {
  var elements = document.querySelectorAll(el);
  elements.forEach(function (element) {
    return element.classList.remove(activator);
  });
}
...
function onClickMenu() {
  ...
  overlay.addEventListener('click', onOverlayOrLinkClick, {
    once: true
  });
  var linkItems = document.querySelectorAll('[data-item-link]');
  linkItems.forEach(function (el) {
    return el.addEventListener('click', onOverlayOrLinkClick, {
      once: true
    });
  });
  var logo = document.querySelector('[data-nav-logo]');
  logo.addEventListener('click', onOverlayOrLinkClick, {
    once: true
  });
